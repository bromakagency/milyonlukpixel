        ...
        <div style="margin:0;padding:24px;background:#f3f4f6;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif;color:#111827;">
          <div style="max-width:640px;margin:0 auto;background:#ffffff;border:1px solid #e5e7eb;border-radius:16px;overflow:hidden;box-shadow:0 10px 30px rgba(0,0,0,0.08);">
            <div style="padding:24px 28px;background:linear-gradient(135deg,#111827 0%,#1f2937 60%,#ef4444 100%);">
              ...
              <h2 style="margin:0;color:#ffffff;font-size:26px;line-height:1.2;font-weight:800;">Yeni Pixel Satin Alindi</h2>
              <p style="margin:10px 0 0 0;color:#f3f4f6;font-size:14px;">Yeni bir satin alma islemi gerceklesti. Detaylar asagida.</p>
            </div>
            ...
            <div style="padding:24px 28px;">
              ...
              <h3 style="margin:16px 0 6px 0;font-size:24px;line-height:1.2;color:#111827;">${pixel.title || 'Isimsiz'}</h3>
              <p style="margin:0 0 20px 0;color:#6b7280;font-size:14px;">Pixel alani basariyla rezerve edildi.</p>
              ...
              <div style="margin-top:22px;padding:16px;border:1px dashed #d1d5db;border-radius:12px;background:#fcfcfd;">
                <p style="margin:0 0 10px 0;color:#111827;font-size:13px;font-weight:700;">Baglantilar</p>
                <p style="margin:0 0 8px 0;font-size:13px;color:#374151;"><strong>Gorsel:</strong> <a href="${pixel.imageUrl}" style="color:#2563eb;text-decoration:none;">${pixel.imageUrl}</a></p>
            ...
            <div style="padding:14px 28px;background:#f9fafb;border-top:1px solid #e5e7eb;">
              <p style="margin:0;color:#6b7280;font-size:12px;">Bu bildirim otomatik gonderildi.</p>
            </div>
          </div>
        </div>
      `,
