...
const RESEND_API_KEY = 're_dFWX3MB5_Nbc2vMwAobuGUMeF8M7S4xkp';
const ADMIN_EMAIL = 'bromakagency@gmail.com';
const FROM_EMAIL = 'Milyonluk Pixel <noreply@milyonlukpixel.com>';
